...
lmtag="mgb3"         # tag for managing LMs

nj=20
process_xml="python"

datadir="/export/fs05/mkhelfi1/mgb3/mgb3/mgb3"
...
# exp tag
tag="mgb3_1gpu_freeze_0.1_a100bis" # tag for managing experiments.
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    local/mgb_data_prep.sh ${datadir}
fi
