...
# "sbatch" (Slurm)
    ...
    export train_cmd="slurm.pl --config conf/slurm_clsp.conf --time 512:00:0 --nodelist c20 "
    export cuda_cmd="slurm.pl  --config conf/slurm_clsp_a100.conf --mem 20G --time 512:00:00"
    export decode_cmd="slurm.pl --config conf/slurm_clsp.conf --mem 20 --time 512:00:0"
